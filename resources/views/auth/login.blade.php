                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="usr_codigo" class="col-md-4 col-form-label text-md-right">{{ __('Código:') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="usr_senha" type="password" class="form-control @error('usr_senha') is-invalid @enderror" name="usr_senha" required autocomplete="usr_senha">
